...
To upload the files you must not be connected to the instance. Open a new console and type this, with the path to your key and the path to your server folder:
